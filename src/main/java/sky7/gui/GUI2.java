...
public class GUI2 implements ApplicationListener {
	...
	public GUI2(IClient client) throws FileNotFoundException {
		this.client = client;
		textures = new HashMap<>();
		sprites = new HashMap<>();
	}
	...
	public void reset() {
		...
		if (pointer == 5) {
			client.getPlayer().clearRegistry();
		} else {
//			localregistry.clear();
